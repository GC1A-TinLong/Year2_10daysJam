...
void StageScene4::Update()
{
	...
	switch (phase_)
	{
	case StageScene4::Phase::kFadeIn:
		fade_->Update();
		SetPlayerStatus();
		UI->Update(true, false);
		break;
#pragma region Play
	case StageScene4::Phase::kPlay:
...
#pragma region Countdown
	...
	case StageScene4::Phase::kCountdown:
		UI->Countdown();
		break;
...
#pragma region kStageClear
	case StageScene4::Phase::kStageClear:
		...
		break;
#pragma endregion
	case StageScene4::Phase::kFadeOut:
		fade_->Update();
		break;
	}
}

void StageScene4::ChangePhase()
{
	switch (phase_)
	{
	case StageScene4::Phase::kFadeIn:
...
void StageScene4::CheckAllCollision()
{
...
void StageScene4::SetPlayerStatus()
{
...
void StageScene4::UserInterfaceDepthMeter()
{
